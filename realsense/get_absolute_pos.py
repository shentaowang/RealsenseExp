...
class CWaitForMessage:
    ...
    def estimate_absolute_pos(self, obj_pos, obj_depth):
        ...
        abs_pos = abs_pos.flatten()
        abs_pos -= self.external_mat[:, 3]
        return abs_pos
    ...
    def callback(self, img_data, depth_data, pos_data, camera_info):
        ...
        pos_str = "x: {}, y:{}, z:{}".format(obj_absolute_pos[0], obj_absolute_pos[1], obj_absolute_pos[2])
        cv2.putText(cv_color_img, pos_str, (20, 29), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
